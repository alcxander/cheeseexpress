...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  if (req.query.roundtrip) params.set('roundtrip', String(req.query.roundtrip))
  ...
  const url = `https://api.mapbox.com/optimized-trips/v1/mapbox/driving/${coordinates}?${params.toString()}`
